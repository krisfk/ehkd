...
?>
    ...
    <a href="<?php echo get_field('bottom_img_1_link');?>" class="bottom-img-link bottom-about-link-a col g-0">
...
?>
    ...
    <a href="<?php echo get_field('bottom_img_2_link');?>" class="bottom-img-link bottom-about-link-a  g-0">
        <img class="rect-img" src="<?php echo $img_src;?>" alt="">
...
$img_src=$img_arr[0];
?>
    <a href="<?php echo get_field('bottom_img_3_link');?>" class="bottom-img-link bottom-about-link-a  g-0">
        <img class="rect-img" src="<?php echo $img_src;?>" alt="">
...
$img_src=$img_arr[0];
?>
    <a href="<?php echo get_field('bottom_img_4_link');?>" class="bottom-img-link bottom-about-link-a  g-0">
        <img class="rect-img" src="<?php echo $img_src;?>" alt="">
...
$img_src=$img_arr[0];
?>
    <a href="<?php echo get_field('bottom_img_5_link');?>" class="bottom-img-link bottom-about-link-a  g-0">
        <img class="rect-img" src="<?php echo $img_src;?>" alt="">
